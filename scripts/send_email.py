...
RECIPIENTS = ["danielhe9999@gmail.com", "xianghe@live.com", "lihwang@live.com", "he.samuel300@gmail.com"]
...
def build_price_movement_section(pm):
    ...
    def mov_rows(stocks, direction):
        if not stocks:
            return f'<tr><td colspan="8" style="padding:16px;text-align:center;color:#6b7a94">No stocks {direction} 3 consecutive days.</td></tr>'
        rows = ""
...
<div style="max-width:760px;margin:0 auto;padding:24px 16px">
  ...
  <div style="border-bottom:1px solid #1e2a3a;padding-bottom:18px;margin-bottom:22px">
    ...
    <div style="color:#6b7a94;font-size:13px;margin-top:4px">Nightly S&amp;P 500 Digest &mdash; {today}</div>
  </div>
